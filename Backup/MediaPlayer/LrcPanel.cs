...
namespace MediaPlayer
{
    public partial class LrcPanel : UserControl
    {
        ...
        {
            //int m =(int)lrcSortedList.ElementAt(currentLrcIndex).Key/60;
            //int s = lrcSortedList.ElementAt(currentLrcIndex).Key - m * 60;
                ...
                if (e.Button == MouseButtons.Left && lrcSortedList.Count > 0)
                {
                    ...
                    if (ismouseDown == true)
                    {
                        ...
                        if (e.Y < p7.Y)//下移
                        {
                            ...
                            //if (this.fontStyle.Height * (currentLrcIndex + space + 1 + lines) < space * this.fontStyle.Height)
                            //{
                            //}
                        ...
                        if (e.Y > p7.Y)//上移
                        {
                            ...
                            //if ((this.fontStyle.Height * (currentLrcIndex + space + 1 + lines)) > ((space + lrcSortedList.Count - 1) * this.fontStyle.Height))
                            //{
            ...
            if (currentLrcIndex <= lrclines / 2)//最上
            {
                ...
                for (; index < lrclines; index++)
                {
                    ...
                    if (lrcSortedList.ElementAt(index).Key == (minute + second))//高亮显示当前歌词
                    {
                        ...
                        //    {
                        //        width = imgLeft;
                        //        g.DrawString(lrcSortedList.ElementAt(i).Value, f, lightBrush, this.imgLrc.Width / 2, f.Height * (i + space + 1 + lines), format);
                        //        g.Flush();
                        //        if (imgLrc != null && imgBack != null)
                        //        {
                        //            Rectangle rec = new Rectangle(0, 0, width, this.imgBack.Height);
        ...
        private void 选择ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (o.ShowDialog() == DialogResult.OK)
            {
                ...
                //this.FindForm().BackgroundImage = Image.FromFile(o.FileName);
